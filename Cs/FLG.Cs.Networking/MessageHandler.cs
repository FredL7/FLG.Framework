namespace FLG.Cs.Networking {
    internal class MessagesHandler(Dictionary<int, MessagesHandler.MessageHandler> messageHandlers) {
        internal delegate void MessageHandler(int sourceId, Message message);

        public Dictionary<int, MessageHandler> MessageHandlers { get => messageHandlers; }
